...
- If you'd rather ask questions than write requests, [connect Sendspark to an AI assistant over MCP](/connect-ai-apps-mcp) and query your campaigns, prospects, and analytics in plain language.
- Once a video exists, you can also [get its transcript via the API](/api-get-video-transcripts-via-api) as JSON or as a WebVTT or SubRip subtitle file.
