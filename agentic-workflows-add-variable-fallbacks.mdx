...
- Set **The first field. Input data** to the field you want to check and the **The second field. List for comparison** to **Empty list** to detect blanks.
...
2. For the **The first field. Input data**, select the field you want to check (e.g. "First Name").
3. For the **The second field. List for comparison**, select **Empty list**.

This setup lets the workflow detect when the selected field is empty.

*Example:*

![Table replacement tool configuration showing The first field. Input data and Empty list selection](/images/12309834/e9e599c2-Screenshot_2025-09-17_at_12_09_26_AM.png)
...
<AccordionGroup>
  ...
  <Accordion title="How do I detect an empty field?">
    Add the Table replacement tool, set **The first field. Input data** to the field you want to check (e.g. "First Name"), and set the **The second field. List for comparison** to **Empty list**. That configuration lets the workflow tell when the field is empty.
  </Accordion>
