...
You can upload contacts to Sendspark, generate personalized videos, and auto-send them from Outlook using an Agentic Workflow. Trigger the workflow on Sendspark's **New Video Generated** event, add a Microsoft Outlook **Create Draft Email** action, then a **Send Email** action — and each contact is emailed their own video automatically once it's created.

## Key takeaways

- You'll need **admin access** to Outlook (to connect the Sendspark app) and the **Agentic Workflows** feature in Sendspark (currently in Beta).
...
2. **Agentic Workflow**s feature in Sendspark (currently in Beta)
...
## Step 2: Create Your Agentic Workflow

Go to the [Agentic Workflow](https://sendspark.com/agentic-workflows) Section of Sendspark.

Select**"New automation"**

![The button that starts a new automation](/images/10721594/d162a196-image.png)
...
Under **Dynamic Campaign ID**, **select the Dynamic Video Campaign** from the previous step.
...
For the action, select **Microsoft Outlook** and **Create Draft Email**. Choose your connected account under **Connect your Microsoft Outlook account**, then click **Continue**
...
<AccordionGroup>
  <Accordion title="What do I need to connect Sendspark and Outlook?">
    Two things: **admin access** to Outlook (so you can connect the Sendspark app) and the **Agentic Workflows** feature in Sendspark, which is currently in Beta.
  </Accordion>
