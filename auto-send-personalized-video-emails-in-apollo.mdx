...
- Use ****Sendspark: New Video Generated - Specific Campaign**** as the trigger so contacts only enroll once their personalized video is ready.
...
- Otherwise, simply use **“Sendspark: New Video Generated - Specific Campaign”** as the trigger and connect the dynamic video campaign you'd like to use ​![Sendspark automation trigger selection with Sendspark: New Video Generated - Specific Campaign option](/images/12178551/9aa7629a-image.png)
...
- `contact_ids` → `StringArray` → insert this dynamically from the **Find Contact** step
...
- `X-Api-Key` → `String` → Get your Apollo API key here: [Apollo Developer Keys](https://developer.apollo.io/keys)
...
<AccordionGroup>
  <Accordion title="How do I automatically send personalized video emails in Apollo?">
    Create a Dynamic Video Campaign in Sendspark, paste a Sendspark placeholder into your Apollo sequence email, then build a Sendspark automation that triggers on "Sendspark: New Video Generated - Specific Campaign," finds the contact in Apollo by email, and calls the Apollo API to enroll them in your sequence. Contacts are added automatically once their video is ready.
  </Accordion>
  <Accordion title="What trigger should I use for the Sendspark automation?">
    If you already have a trigger such as "Contact added to Apollo list" or "Contact added in HubSpot," use that. Otherwise use **Sendspark: New Video Generated - Specific Campaign** and connect the dynamic video campaign you want to use, so contacts enroll only after their video is ready.
  </Accordion>
