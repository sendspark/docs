---
title: "GHL - Automatically Generate and Send Videos in Sendspark via SMS Using Go High Level "
---
...
**GoHighLevel** Contact triggers the workflow ↓ **Agente Workflows** Creates the personalized Sendspark video ↓ **GoHighLevel** Receives and stores the video link ↓ **SMS** Automatically sends the video link to the contact
