...
- DNS propagation can take up to 48 hours; don't launch new campaigns until the domain is fully propagated and verified in Sendspark.
...
<AccordionGroup>
  ...
  <Accordion title="How long does the migration take to go live?">
    DNS propagation can take up to 48 hours. Once everything resolves, Sendspark automatically verifies the new domain. Don't launch new campaigns until DNS is fully propagated and the domain is verified.
  </Accordion>
</AccordionGroup>
