...
2. In the blog editor, open **Insert → Embed** and paste the code.
...
4. Go back to your blog editor, and open **Advanced** and then **Source code**.
...
```html
<p>...</p><iframe style="border-radius: 6px; margin: 0px auto; display: block;" xml="lang" src="https://sendspark.com/embed/0rq5z0pi6or4lvwuuqxbhwfl2b3qwdnp" width="400" height="300" frameborder="0" allowfullscreen="allowfullscreen"></iframe><p>...</p>
```
